    ...
    var script$6 = {
        ...
        methods: {
            ...
            switchCellToViewMode() {
                ...
                utils.OverlayEventBus.off('overlay-click', this.eventBusKey);
            },
            onClick(event) {
                if (this.editMode === 'cell' && this.isEditable()) {
                    ...
                    if (!this.d_editing) {
                        ...
                        utils.OverlayEventBus.on('overlay-click', e => {
...
}(primevue.utils, primevue.api, primevue.paginator, Vue, primevue.dropdown, primevue.button, primevue.ripple));
